...
<?php if($showGoogleTranslate&&!$showLanguagesSelector): ?>
    ...
    <?php $__env->stopSection(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.front', ['class' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel\foodTIger_complete\FoodTiger(work)\resources\views/restorants/show.blade.php ENDPATH**/ ?>